...
bacteria1.src = 'https://mdn.mozillademos.org/files/1429/Canvas_earth.png';
bacteria2.src = 'https://mdn.mozillademos.org/files/1443/Canvas_moon.png';
bgImage.src = 'http://i.imgur.com/5xZxGCa.jpg';
...
var FishEgg = function () {
  ...
  _createClass(FishEgg, [{
    ...
    value: function createEyes() {
      this.createCircle(this.x + this.fish_egg.offset2, this.y + this.fish_egg.offset2, this.fish_egg.radius2 + 4, "rgba(241, 242, 244, 1)");
    ...
    //  this.createEyes();
     ...
     /* this.canvas.lineWidth = Math.random() * 2.2;
      ...
      this.canvas.stroke();
      this.canvas.closePath();*/
      this.canvas.drawImage(bacteria1,this.x, this.y, this.width, this.height);
...
var FishLarvaEgg = function () {
  ...
  _createClass(FishLarvaEgg, [{
    ...
    value: function render() {
      ...
      this.canvas.fill();
      this.canvas.closePath();*/
    //  this.canvas.drawImage(bacteria2,this.x, this.y, this.width, this.height);
    }
  }, {
    key: "move",
    value: function move() {
...
function clear() {
  ...
  drawImageProp(canvas, bgImage, 0, 0, tela.width, tela.height, 0.5, 0.5);
...
function drawImageProp(canvas, img, x, y, w, h, offsetX, offsetY) {
    ...
    canvas.drawImage(bgImage, cx, cy, cw, ch,  x, y, w, h);
}
